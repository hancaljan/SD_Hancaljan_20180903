            ...
            begin
                if "Room Code" = '' then begin
                  ...
                  if (CurrFieldNo <> 0) then begin
                    if (SeminarRoom."CSD Max. Participants" <> 0) and
                       (SeminarRoom."CSD Max. Participants" < "Maximum Participants")
                    then begin
                      if Confirm(Text004,true,
                           "Maximum Participants",
                           SeminarRoom."CSD Max. Participants",
                           FieldCaption("Maximum Participants"),
                           "Maximum Participants",
                           SeminarRoom."CSD Max. Participants")
                      then
                        "Maximum Participants" := SeminarRoom."CSD max. Participants";
                    end;
                  end;
                end;
            end;
